...
!(function(a) {
    ...
    (l.prototype.render = function() {
        ...
        var t =
            ...
            o = a('<span class="toggle-handle btn btn-secondary">').addClass(t),
        ...
        this.$element.wrap(l), a.extend(this, { $toggle: this.$element.parent(), $toggleOn: e, $toggleOff: s, $toggleGroup: i }), this.$toggle.append(i);
        ...
        e.addClass("toggle-on"),
            ...
            this.options.height && (e.css("line-height", e.height() + "px"), s.css("line-height", s.height() + "px")),
            this.update(!0),
            this.trigger(!0);
    }),
