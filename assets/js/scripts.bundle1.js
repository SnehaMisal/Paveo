        ...
        var i = { overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay" },
            ...
            u = function() {
                var e = f(),
                    ...
                    o = m("start"),
                    a = m("end");
                !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(document.body.getAttribute("data-kt-drawer-" + n.name + "-")) ? (n.shown = !0) : (n.shown = !1), !0 === m("activate") ?
...
var KTMenu = function(e, t) {
    ...
    if (null != e) {
        var i = { dropdown: { hoverTimeout: 200, zindex: 107 }, accordion: { slideSpeed: 250, expand: !1 } },
            ...
            l = function(e) {
                e || (e = n.triggerElement), !1 !== m(e) && ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && L(e));
            },
            s = function(e) {
                if (!1 !== f(e)) {
                    var t = g(e);
            ...
            U = function(e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    null !== a && a >= o && (o = a + 1),
                        ...
                        KTUtil.addClass(t, "show"), !0 === I(e, "overflow") ? (document.body.appendChild(t), KTUtil.data(e).set("sub", t), KTUtil.data(t).set("item", e), KTUtil.data(t).set("menu", n)) : KTUtil.data(t).set("item", e),
            ...
            w = function(e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                    ...
                    KTUtil.css(t, "z-index", ""),
                        ...
                        KTUtil.removeClass(t, "show"), !0 === I(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e), KTUtil.data(e).remove("sub"), KTUtil.data(t).remove("item"), KTUtil.data(t).remove("menu")),
                        E(e),
            ...
            A = function(e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.show", e)) {
                    ...
                    !0 === I(e, "expand") ? (i = !0) : !1 === I(e, "expand") ? (i = !1) : !0 === I(n.element, "expand") && (i = !0), !1 === i && x(e), !0 === KTUtil.data(e).has("popper") && w(e),
            ...
            x = function(e) {
                ...
                if (i && i.length > 0)
                    for (var r = 0, o = i.length; r < o; r++)(t = i[r]), "accordion" === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && L(t);
            },
            I = function(e, t) {
                var n,
                    i = null;
        ...
        var i = { minLength: 2, keypress: !0, enter: !0, layout: "menu", responsive: null, showOnFocus: !0 },
            ...
            o = function() {
                n.inputElement.addEventListener("focus", a),
                    n.inputElement.addEventListener("blur", l), !0 === g("keypress") && n.inputElement.addEventListener("input", u),
                    n.submitElement && n.submitElement.addEventListener("click", d), !0 === g("enter") && n.inputElement.addEventListener("keypress", s),
            ...
            c = function() {
                !1 !== KTEventHandler.trigger(n.element, "kt.search.clear", n) &&
                    ((n.inputElement.value = ""),
                        n.inputElement.focus(),
                        n.clearElement && n.clearElement.classList.add("d-none"),
                        n.toolbarElement && n.formElement.contains(n.toolbarElement) && n.toolbarElement.classList.remove("d-none"), !1 === g("show-on-focus") && p(),
                ...
                if (!1 !== i)
                    if (((i = parseInt(i)), (t = KTUtil.getScrollTop()), document.documentElement.scrollHeight - window.innerHeight - KTUtil.getScrollTop(), !0 === r)) {
                        if (t > i) {
                            ...
                            !0 === document.body.hasAttribute(n.attributeName) && (l(), document.body.removeAttribute(n.attributeName), document.body.removeAttribute(n.attributeName2)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), KTEventHandler.trigger(n.element, "kt.sticky.change", n), (n.eventTriggerState = !0));
                        n.lastScrollTop = t;
                    } else if (t > i) {
                    if (!1 === document.body.hasAttribute(n.attributeName)) {
                        if (!1 === a()) return;
        ...
        offset: function(e) {
            ...
            if (e)
                return e.getClientRects().length ?
                    ((t = e.getBoundingClientRect()), (n = e.ownerDocument.defaultView), { top: t.top + n.pageYOffset, left: t.left + n.pageXOffset, right: window.innerWidth - (e.offsetLeft + e.offsetWidth) }) : { top: 0, left: 0 };
        },
        height: function(e) {
    ...
    return {
        ...
        createInstances: function() {
            [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(e) {
                ...
                r(),
                r(),
                o(), !1 === t && (o(), window.addEventListener("scroll", o)), [].slice.call(document.querySelectorAll('[data-kt-countup-tabs="true"][data-bs-toggle="tab"]')).map(function(e) {
