...
<head>
    ...
    <title>Paveo | Sales Staff List</title>
                                        ...
                                        <table class="datatables-users table border-top table-hover table-striped" id="data_table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>+91 9876543210</td>
                                                    <td>
                                                        <span class="badge badge-center bg-label-primary">10</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-nowrap">
                                                            <a href="<?php echo base_url('sales_staff_profile') ?>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>+91 9876543210</td>
                                                    <td>
                                                        <span class="badge badge-center bg-label-primary">90</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>+91 9876543210</td>
                                                    <td>
                                                        <span class="badge badge-center bg-label-primary">50</span>
                                                    </td>
                                                    <td>
