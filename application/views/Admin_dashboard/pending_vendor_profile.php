                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row justify-content-center">
                                        ...
                                        <div class="row ">
                                            <div class="col-md-6">
                                                <div class="info">
                                                    ...
                                                    <!-- <p class="mb-1"><strong>Shop Name :</strong>ABC Shop</p> -->
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="info">
                                                <p class="mb-1"><strong>Shop Name :</strong>ABC Shop</p>
                                                    <p class="mb-1"><strong>GST No.: </strong>987654321
                                                    </p>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item text-success"
                                                                ...
                                                                Verify</a>
                                                            <a class="dropdown-item text-danger"
                                                                href="javascript:void(0);"><i class='bx bx-x me-1'></i>
                                                                Reject</a>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="card border radius-10 mb-3 ">
                                    <div class="card-body ">
                                        <h6 class="mb-2">FSSAI Registration</h6>
                                        <div class="card border shadow-none">
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <span class="badge bg-label-primary">Pending</span>
                            ...
                            <div class="col-md-3">
                                <div class="card border radius-10 mb-3 ">
                                    <div class="card-body ">
                                        <h6 class="mb-2">Current Account Cheque</h6>
                                        <div class="card border shadow-none">
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <span class="badge bg-label-primary">Pending</span>
                            ...
                            <div class="col-md-3">
                                <div class="card border radius-10 mb-3 ">
                                    <div class="card-body ">
                                        <h6 class="mb-2">Shop & Establishment License</h6>
                                        <div class="card border shadow-none">
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <span class="badge bg-label-primary">Pending</span>
                            ...
                            <div class="col-md-3">
                                <div class="card border radius-10 mb-3 ">
                                    <div class="card-body ">
                                        <h6 class="mb-2">Trade Certificate/License</h6>
                                        <div class="card border shadow-none">
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <span class="badge bg-label-primary">Pending</span>
                            ...
                            <div class="col-md-3">
                                <div class="card border radius-10 mb-3 ">
                                    <div class="card-body ">
                                        <h6 class="mb-2">Other Shop Documents</h6>
                                        <div class="card border shadow-none">
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between">
                                                    <span class="badge bg-label-primary">Pending</span>
