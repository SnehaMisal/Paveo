...
<body>
    ...
    <!--Create Size Modal -->
    <div class="modal fade cust_modal" id="create_size" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <!-- <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="form-select create_size" id="" required="" name="">
                                    <option selected="" disabled="" value="">Choose...</option>
                                    <option value="1">Shirts</option>
    ...
    <script>
    $('.select2').select2({
        dropdownParent: $('#create_size'),
        minimumResultsForSearch: Infinity,
        width: "100%",
    });
    $('.create_size').select2({
        dropdownParent: $('#edit_size'),
        minimumResultsForSearch: Infinity,
        width: "100%",
    });
    // $('.select2').select2({
