...
<head>
    ...
    <title>Paveo | Create Sub-Category</title>
...
<body>
                                        ...
                                        <table class="datatables-users table border-top table-hover table-striped"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Shirts</td>
                                                    <td><span class="fw-semibold text-primary"> Formal Shirts</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td>Jeans</td>
                                                    <td><span class="fw-semibold text-primary">Formal Jeans</span></td>
                                                ...
                                                <tr>
                                                    <td>3</td>
                                                    <td>Short</td>
                                                    <td><span class="fw-semibold text-primary">Sport Shorts</span></td>
                                                    <td>
                                                        <div class="product-box">
                                                            <a href="<?php echo base_url() ?>assets/images/cat_shirt.png"
                                                                data-exthumbimage="<?php echo base_url() ?>assets/images/cat_shirt.png"
            ...
            <div class="modal-content">
                <form action="" method="post" class="needs-validation" novalidate>
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Create Sub-Category</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="" class="form-label">Sub-Category Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="" class="form-control" placeholder="Enter Sub-Category Name"
                                    value="" required>
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                <label for="" class="form-label">Sub-Category Image <span
                                        class="text-danger">*</span></label>
                                <input type="file" id="dropify_img" class="dropify" name="" data-default-file=""
                                    data-height="150" required data-allowed-file-extensions="png jpg jpeg" />
                                <div class="invalid-feedback" id="invalid-feedback">Please Enter Sub-Category Image.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="" class="form-label">Category Name <span
                                        class="text-danger">*</span></label>
                                <select class="form-select edit_subcat" id="" required="" name="">
                                    <option selected="" disabled="" value="">Choose...</option>
                                    <option value="1">Shirts</option>
    ...
    $(document).ready(function() {
        $('.select2').select2({
            dropdownParent: $('#create_subcategory'),
            minimumResultsForSearch: Infinity,
            width: "100%",
        });
        $('.edit_subcat').select2({
            dropdownParent: $('#edit_subcategory'),
            minimumResultsForSearch: Infinity,
            width: "100%",
        });
    })
