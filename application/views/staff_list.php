                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-nowrap">
                                                            ...
                                                            <button class="btn btn-sm btn-icon delete-record" id="delete_1" onclick="delete_fun(this)"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-nowrap">
                                                            ...
                                                            <button class="btn btn-sm btn-icon"><i
                                                                    class="bx bx-edit"></i></button>
                                                            <button class="btn btn-sm btn-icon delete-record" id="delete_2" onclick="delete_fun(this)"><i
                                                                    class="bx bx-trash"></i></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-block text-nowrap">
                                                            ...
                                                            <button class="btn btn-sm btn-icon"><i
                                                                    class="bx bx-edit"></i></button>
                                                            <button class="btn btn-sm btn-icon delete-record" id="delete_3" onclick="delete_fun(this)"><i
                                                                    class="bx bx-trash"></i></button>
                                                        </div>
                                                    </td>
                                                </tr>
